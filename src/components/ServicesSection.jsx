  ...
  const services = [
    {
      ...
      description: "Универсальный массаж всего тела для снятия напряжения, улучшения тонуса мышц и общего расслабления."
    },
    {
      id: 2,
      ...
      description: "Глубокое воздействие предплечьями: снимает спазмы, боль, дарит мощное расслабление. Массаж проходит под специально подобранную музыку."
    },
    {
      id: 3,
      title: "Массаж ног",
      ...
      description: "Быстрое снятие усталости, отеков и тяжести в ногах. Подходит спортсменам. "
    },
    {
      id: 4,
      ...
      description: "Снимает боль, напряжение от сидячей работы, восстанавливает легкость движений."
    },
  ];
